...
module.exports = {
    // ===== BOT CORE SETTINGS =====
    SESSION_ID: process.env.SESSION_ID || "SUBZERO-MD~5xB3nLpC#xQlZ0nwPNGxVm0-JAvuUJpGHCq6TAa0A6jgNE_n0sR4",  // Your bot's session ID (keep it secure)
    ...
    OWNER_NUMBER: process.env.OWNER_NUMBER || "237676894475",  // Owner's WhatsApp number
